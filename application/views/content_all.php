...
<main role="main" id="home">
  <section class="jumbotron bg-info text-center" id="home" style="padding-top:12rem; padding-bottom:15rem; height:100%;">
    <div class="container">
      <h1 class="jumbotron-heading text-white">Fiqs Internship</h1>
  ...
  <div class="bg-light" id="tentang" style="padding-top:100px; padding-bottom:100px; height:100%;">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-5">
            <img src="<?= base_url('include/assets-fe/assets/img/about.jpg')?>" class="card-img-top hvr-grow" alt="...">
        </div>
        <div class="col-md-7">
            <div class="card-body">
                <h3>Belajar bersama kami</h3>
                <p><em>Fiqs magang adalah perusahaan dibidang.. bidang apaan ya</em></p>
                <ul>
                ...
                <p>
                  Kami menjamin Mahasiswa akan belajar banyak hal tentang perusahaan fiqs ini
                </p>
            </div>
        </div>
      </div>
