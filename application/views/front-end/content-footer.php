    <footer class="container-fluid bg-light" id="kontak">
      <div class="row container d-flex m-auto">
        <div class="col-md-3 mb-4 mt-3">
          <img src="<?= base_url('include/assets-fe/assets/img/fiqs-smol-logo.png')?>"><span class="text-dark"> iqs | Internship</span>
          <p class="small mt-2">Gedung Menara Merdeka, Lt.9, Jalan Budi Kemuliaan 1 No.2, RT.2/RW.3, Gambir, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10110</p>
          <small>&copy; 2020 Fiqisulaiman</small>
        </div>
        <div class="col-md-3 mb-3 mt-3">
          ...
          <ul class="list-unstyled text-small" style="margin-left: 1px;">
            ...
            <li><p><a class="text-muted" href="#"><i class="icofont icofont-sign-in text-aqua"></i> Login</a></p></li>
            <li><p><a class="text-muted" href="#"><i class="icofont icofont-pen-alt-2 text-aqua"></i> Daftar</a></p></li>
          </ul>
        </div>
        ...
        <div class="col-md-3 mb-3 mt-3">
          ...
          <ul class="list-unstyled text-small" style="margin-left: 1px;">
            ...
            <li><p class="text-muted"><i class="icofont icofont-whatsapp text-aqua"></i> +62 896 7654 4325</p></li>
            <li><p class="text-muted"><i class="icofont icofont-envelope-open text-aqua"></i> Fiqisulaiman@gmail.com</p></li>
          </ul>
        </div>
