...
<form class="form-signin" method="POST" action="<?= site_url('login/process')?>">
  ...
  <div class="text-center mb-4">
    <img class="mb-4" src="<?= base_url('include/assets-fe/assets/img/favicon/fiqs-logo.png')?>" alt="" width="72" height="72">
  ...
  <p class="mt-5 mb-3 text-muted text-center">&copy; 2020 Fiqisulaiman</p>
</form>