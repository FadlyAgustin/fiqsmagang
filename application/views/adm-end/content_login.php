...
<head>
  ...
  <link rel="icon" href="<?= base_url('include/img/favicon-32x32.png') ?>">
...
<div class="login-box">
  <div class="login-logo">
    <a href="#">
      <b><h4>Fiqs Internship | Administrator</h4></b>
    </a>
  </div>
  <div class="card">
    <div class="card-body login-card-body">
        <img src="<?= base_url('include/img/fiqs-logo.png') ?>" width="100" class="img-fluid d-block m-auto">
        <?php
